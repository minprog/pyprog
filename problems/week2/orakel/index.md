...
Als de gebruiker als antwoord `42`, `tweeenveertig`, of `tweeënveertig` geeft, moet het programma `Ja` printen, bij elk ander antwoord `Nee`.
...
Ontwerp je code zoals hieronder beschreven. Vul de docstrings aan met doctest en eventueel verdere uitleg.
    ...
    if __name__ == `__main__`:
        Prompt hier de gebruiker om een antwoord, roep je functie aan, en print het antwoord van het orakel.
