...
- Je gaat aan de slag met `for`- en `while`-loops waarmee je reeksen kunt afgaan of een simulatie bouwen.
...
Heb je al programmeerervaring? Dan mag je je eigen programma wat aanpassen:
