...
1. Schrijf een functie `shout` die een string aanneemt en een ALLE WOORDEN IN HOOFDLETTERS schrijft.
...
Tekens aanpassen in een string kan niet, dus het is nodig om een nieuwe string aan te maken en stap-voor-stap te vullen met tekens, waarbij je letters zonodig aanpast.
...
Een voorbeeld van het runnen van het programma:
