...
Encryptie is van alle tijden. Hier maak je twee functies die de [Caesar cypher](https://en.wikipedia.org/wiki/Caesar_cipher) implementeren --- zo oud als de weg naar Rome.
...
Bouw er een `main` bij waarin wordt gevraagd om een tekst en een rotatie, en de tekst dan wordt gecodeerd of gedecodeerd.
