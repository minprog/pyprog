# Week 3: Variabelen en Loops in Python

Dit is het overzicht voor week 3 van de 16-weekse cursus Programmeren in Python. Deze week nemen we afscheid van Karel, en stappen we over naar écht programmeren in Python. 
...
- Net als bij Karel gebruiken we in python hoofdfuncties, hulpfuncties, *if*-statements, en *while*-loops. 
- In Karel gebruikte we al ITERATE. In Python kan dit door middel van een *for*-loop. 
- Nieuw in Python: In de functies gebruik je soms *variabelen* om uitkomsten in op te slaan. Variabelen zijn essentieel om te leren begrijpen.
...
Voor studenten met programmeerervaring kan het lijken alsof we wat langzaam gaan. Let op het volgende:
...
Tijdens het werkcollege gaan we een aantal functies uitpuzzelen. Deze programmeer je vervolgens in de tentamen editor. Dit is dezelfde omgeving waarin de tentamens gegeven worden! Daarom is het belangrijk om hier bekend mee te raken. Daarnaast is dit ook hét moment om Python en een editor te installeren op je computer. 

Later in de week is er ook een laptopcollege. Tijdens het laptopcollege ga je werken aan de opdrachten en er is veel ruimte om vragen te stellen en met andere studenten eerste opzetjes te maken voor je huiswerk. Ook zal de docent nog één of twee programma's live uitwerken zodat je kunt meekijken hoe dat gaat.
