...
1. Download de [Zed editor](https://zed.dev) en installeer volgens de instructies.

    * Kies een **Stable** release van de editor.
...
3. Als je Zed hebt opgestart, kies dan "File" -> "Open Folder" en kies de directory die je hebt aangemaakt om aan dit vak te werken. Als het goed is zie je nu alle files in deze folder aan de linker zijde van het scherm. 
